...
The collision OBJ files are conversions of the Robowflex Panda collision
meshes distributed by VAMP. Robowflex Resources records the upstream Panda
sources as:
...
CoMotion modifies the generated Panda URDF so that the packaged collision
meshes are also used for visualization. No endorsement by Franka Robotics,
MoveIt, Rice University, or the Kavraki Lab is implied.
