...
///
/// Composite RRT* treats all robots as one composite system and optimizes in
/// the selected composite metric.
class CompositeRRTStar : public MultiRobotPlanner {
public:
    ...
    std::string name() const override { return "CompositeRRTStar"; }
